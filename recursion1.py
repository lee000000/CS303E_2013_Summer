...
#  Description: Java/python Practice 

#  Student Name: Chengxi Li#  Student UT EID:cl29385 
...
def countX(str):
  ...
  if (len(str) == 0 ):
    ...
    if (str[-1] == "x"):
      return countX(str[0:len(str) - 1]) + 1
    else:
      return countX(str[0:len(str) - 1]) + 0
...
def countHi(str):
  ...
  if (len(str) == 0 or len(str) == 1):
    ...
    if (str[(len(str) - 2): len(str)] == "hi"):
      return countHi(str[0:len(str) - 1]) + 1
    else:
      return countHi(str[0:len(str) - 1]) + 0
...
def changeXY(str):
  ...
  if (len(str) == 0):
    ...
    if (str[-1] == "x"):
      ...
      return changeXY(str[0:len(str)-1]) + str[-1]
...
def changePi(str):
  ...
  if (len(str) == 0 or len(str) == 1):
    ...
    if (str[len(str) - 2: len(str)] == "pi"):
      ...
      return changePi(str[ 0 : len(str) - 1]) + str[-1]
...
def noX(str):
  ...
  if (len(str) == 0 or len(str) == 1):
    ...
    if (str[-1] == "x"):
      ...
      return noX(str[0 : len(str) - 1]) + str[-1]
...
def array6(nums, index):
  ...
  if (len(nums) == 0):
    ...
    if 6 in nums[index:]:
      return array6(nums[index + 1:], index) or True
    else:
      return array6(nums[index + 1:], index) or False
...
def array11(nums, index):
  ...
  if (len(nums) == 0):
    ...
    if (nums[index] == 11) :
      return array11(nums[index + 1:], index) + 1
    else:
      return array11(nums[index + 1:], index) + 0
...
def array220(nums, index):
  ...
  if (len(nums) == 0 or len(nums) == 1):
    ...
    if (nums[-1] == 10 * nums[index]):
      return True
    else:
      return False
  elif ( len(nums) > 2):
    if ( 10 * int(nums[index]) in nums[index + 1:]):
      return array220(nums[index + 1:], index) or True
    else:
      return array220(nums[index + 1:], index) or False
...
def allStar(str):
  ...
  if (len(str) == 0 or len(str) == 1):
    ...
    return allStar(str[:len(str) - 1]) + "*" + str[-1]
...
def pairStar(str):
  ...
  if (len(str) == 0 or len(str) == 1):
    ...
    if (str[-1] == str[-2]):
      return pairStar(str[:len(str) - 1]) + "*" + str[-1]
    else:
      return pairStar(str[:len(str) - 1]) + str[-1]
...
def countHi2(str):
  ...
  if (len(str) <= 1):
    ...
    if (str[-3] != "x" and str[len(str) - 2: len(str)] == "hi"):
      return countHi2(str[:len(str) -1]) + 1
    else:
      return countHi2(str[:len(str) -1]) + 0
...
def nestParen(str):
  ...
  if (len(str) == 0 or len(str) == 2):
    ...
    if (str[0] == "(" and str[-1] == ")"):
      if (str[1] == "(" and str[len(str)-2] == ")"):
        return nestParen(str[1:len(str) -1]) and True
      else:
        return nestParen(str[1:len(str) -1]) or False
